  ...
  metaInfo: {
    ...
    meta: [
      { name: 'viewport', content: 'width=device-width, initial-scale=1' },
      {
        name: 'description',
        content:
          "Grace's Web Portfolio Vue Vue.js Nuxt Nuxt.js HTML CSS Vuetify Axios GraphQL JavaScript Web Developer Front-End Frontend Designer App Responsive"
      },
      { charset: 'utf-8' },
    ...
    return {
      ...
      projects: [
        ...
        },
        {
          ...
          demo: 'https://dindoo0524.github.io/',
          tech: {
            tech1: 'VUE',
            tech2: 'Storyblok',
            tech3: 'HTML',
